...
<body>
<div class="container">
    <h1><b>upload d'un fichier</b></h1>  
    <form name="upload" id="upload" method="post" action="upload_resultat.php" enctype="multipart/form-data">
        <input type="file" name="fichier"> 
        <br>
        <br>
        <input type="file" name="fichie2">
        <br>
        <br>

DROP DATABASE papyrusexo;

CREATE DATABASE papyrusexo;
...
/*Commandes du fournisseur 91120 */
/*
...
/*Code Fournisseur pour lequels des commandes ont été passées*/
/*
SELECT entcom_numfou AS 'Numero fournisseur ayant reçu commande'
FROM entcom
GROUP BY entcom_numfou;
*/

/*Nombre commande avec nombre fournisseurs distincts*/
...
FROM entcom
WHERE SUBSTRING(CURRENT_TIMESTAMP,1,10) = SUBSTRING(datcom,1,10);
*/
...
/* Commande détaillé par produit et fournisseur */
/*

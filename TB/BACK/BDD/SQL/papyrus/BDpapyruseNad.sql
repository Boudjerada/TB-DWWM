...
/* 1 insertion via requete pour fournis */
...
INSERT INTO fournis VALUES
	...
	('9180','HURRYPATE','68 boulevard des octets','4044','Dumpville','TRACK','0');
/* 2 insertion pour produit qui se réfère a aucune table via outils pour produit.csv*/

LOAD DATA LOCAL INFILE 'C:\\Users\\80010-92-07\\Desktop\\Nadir Boudjerada\\BACK\\BDD\\SQL\\papyrus\\produit.csv'
INTO TABLE produit
FIELDS TERMINATED BY ';'
lines TERMINATED BY '\r\n'
IGNORE 1 LINES
(CODART,LIBART,STKALE,STKPHY,QTEANN,UNIMES);
/*3 insertion pour entcom */

INSERT INTO entcom VALUES
...
/*insertin vente*/
LOAD DATA LOCAL INFILE 'C:\\Users\\80010-92-07\\Desktop\\Nadir Boudjerada\\BACK\\BDD\\SQL\\papyrus\\vente.csv'
INTO TABLE vente
FIELDS TERMINATED BY ';'
lines TERMINATED BY '\r\n'
IGNORE 1 LINES
